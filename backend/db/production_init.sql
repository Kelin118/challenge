-- ============================================================================
-- Achievement Vault production PostgreSQL schema
-- Clean init for a new empty database.
-- Matches the current backend code:
-- - auth via users + sessions
-- - achievements on coins, without XP/levels
-- - challenge platform
-- - submissions / verification
-- - wallet via coin_transactions
-- - feed via completion_events
-- ============================================================================
